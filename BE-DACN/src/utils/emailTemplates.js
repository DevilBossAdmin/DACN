const BRAND = {
  ...
  email: "WebsiteTheGioiDiDong@gmail.com",
...
// ✅ Wrapper dùng chung cho tất cả email
...
const statusColor = (statusUpper) => {
  // bạn có thể tùy biến theo status hệ thống bạn
